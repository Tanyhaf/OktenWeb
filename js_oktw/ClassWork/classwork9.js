...
//     Проітерувати його, створиши для кожного елементу масиву <div class='member'>. Для кожної властивості елементу створити окремий блок, та помістити його у div.member
        ...
        //     document.body.appendChild(divSurname);
...
// Приклад структири знаходиться у файлі example.png
        ...
        //     monthDuration.innerText =`Місяці: ${element.monthDuration}; Години ${element.hourDuration}`
        //     let modules = document.createElement('ul')
        //     for (const modulesKey in element.modules) {
        //         let liModules = document.createElement('li')
        //         liModules.innerText = element.modules[modulesKey]
        //         modules.appendChild(liModules);
        //     }
        //     document.body.appendChild(div)
